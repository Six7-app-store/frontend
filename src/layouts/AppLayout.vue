...
const { isAdmin, isStaff, isStudent } = useRole()
...
const pageTitle = computed(() => {
  ...
  if (name?.startsWith('deployments') || path.startsWith('/deployments')) {
    return t(isStudent.value ? 'nav.environments' : 'nav.deployments')
  }
