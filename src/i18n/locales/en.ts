export default {
  ...
  DashboardView: {
    ...
    // Students never create a deployment; their CTA points at what was
    // assigned to them.
    environmentsOpen: "My environments",
    deployments: "Deployments",
  ...
  HelpView: {
    ...
    introStudent: "This page explains how you get your environment and what to do when it is unavailable.",
    loggedInUsers: {
    ...
    quickHelp: {
      ...
      // Student version: no deployment to create, only an assigned
      // environment to use.
      processTitleStudent: "How you get your environment",
      studentStep1: "Your lecturer sets the environment up for you.",
      studentStep2: "Open \"My environments\" and wait until the status reads \"Ready\".",
      studentStep3: "Open your environment's credentials and sign in with them.",
      ...
      pageDashboardStudent: "Quickly see the environments assigned to you.",
      pageAppsTitle: "Apps",
      pageApps: "Verify the app you need or add new applications and versions.",
      pageAppsStudent: "See which applications exist and what they do.",
      ...
      pageEnvironmentsTitle: "My environments",
      pageEnvironments: "See which environments are assigned to you and get their credentials.",
    ...
    troubleshooting: {
      ...
      item2Student: "If your environment shows \"Unavailable\", contact your lecturer.",
    },
  },
  ...
  DeploymentDetailView: {
    ...
    redeployBusy: 'A lifecycle action is already running for this deployment.',
    redeployError: 'Redeploy failed.',
    taskDetailLoadError: 'Failed to load task details',
    streamLagged: 'Live stream lagged behind — older entries dropped',
    detailsSubtitle: 'Deployment Details',
    releaseTag: 'Release Tag',
    appName: 'App Name',
    noDescription: 'No description',
    gitRepository: 'Git Repository',
    noAppInfo: 'No app information available',
    email: 'Email',
    ...
    noPreviousTasks: 'No previous tasks for this deployment.',
    ...
    confirmResumeMessage: "Resume deployment {name}? All compute instances will be started again.",
  ...
  AppsView: {
    ...
    subtitleStudent: "Overview of the available applications.",
    addApp: "Add App",
  ...
  AppsCreateView: {
    ...
    messages: {
      ...
      validationError: "The data could not be saved. Please check your input.",
  ...
  AppsDetailView: {
    ...
    confirmDeleteMessage: "Delete app {name}? Existing deployments of this app keep working; no new deployments can be started afterwards. The DB row stays for audit.",
    confirmButton: "Delete",
    cancelButton: "Cancel",
  ...
  openstackPicker: {
    ...
    loadError: 'Resource could not be loaded.',
    toasts: {
